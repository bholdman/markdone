...
[![Platform: macOS 14+](https://img.shields.io/badge/Platform-macOS%2014%2B-blue.svg)](#install)
[![Latest release](https://img.shields.io/github/v/release/bholdman/markdone?include_prereleases)](https://github.com/bholdman/markdone/releases/latest)
...
art/                     Source PNGs for the app and menu-bar icons
```
